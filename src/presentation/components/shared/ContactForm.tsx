      ...
      <div className="flex-1 flex flex-col justify-between space-y-8">
        ...
        {success ? (
          <div className="py-8 flex flex-col items-center justify-center text-center space-y-4 bg-theme-bg text-theme-card-text rounded-3xl p-8 border border-theme-card-border shadow-inner animate-in zoom-in-95 duration-300">
            ...
            <h2 className="text-base font-bold font-mono tracking-widest uppercase">{t.contactSuccess}</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  aria-hidden="true"
                  aria-label="Secondary Phone (Spam Honeypot)"
                />
                ...
                <Input
                  ...
                  aria-label={lang === "th" ? "ชื่อ-นามสกุล หรือชื่อองค์กร" : "Full name or Organization"}
                  value={name}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <Input
                    ...
                    aria-label={lang === "th" ? "เบอร์โทรศัพท์สำหรับติดต่อกลับ" : "Phone number for callback"}
                    value={phone}
                  ...
                  <Input
                    ...
                    aria-label={lang === "th" ? "ที่อยู่อีเมลสำหรับติดต่อกลับ" : "Email address for callback"}
                    value={email}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4 bg-theme-bg/40 p-3.5 rounded-full border border-theme-card-border">
                      <input
                        ...
                        aria-label={lang === "th" ? "จำนวนสั่งผลิตเสื้อ" : "Order quantity"}
                      />
                    </div>
                  </div>
              ...
              <textarea
                ...
                aria-label={lang === "th" ? "ข้อความหรือรายละเอียดความต้องการ" : "Message details or specifications"}
                value={message}
